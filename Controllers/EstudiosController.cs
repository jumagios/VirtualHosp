...
namespace VirtualHosp.Controllers
{
    public class EstudiosController : Controller
    {
        ...
        public EstudiosController(HospitalDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Especialidad")] Estudio estudio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Especialidad")] Estudio estudio)
        {
            if (id != estudio.Id)
            {
                return NotFound();
